...
const INITIAL_FORMS: SMSForm[] = [
  ...
  { id: 'f_malta_engine', category: '1. Monthly', formCode: 'COMI-SM-1-8-ENGINE-MALTA', description: 'Malta Flag State Engine Log & Auxiliary Equipment Checklist', formDate: '28 November 2025', scope: 'All Malta Vessels' },
...
%%EOF`;
  ...
  const handleProcessMultipleFiles = async (files: FileList | File[], targetFormId?: string) => {
